 ...
 * resolution. */
#define MUXER_OUTPUT_WIDTH 1280 //640 //1920
#define MUXER_OUTPUT_HEIGHT 720 //480 //1080
...
/* Add a transform element for Jetson*/
  ...
  GstElement *peopleNet_detection = gst_element_factory_make("nvinfer", "peopleNet_detection");
  g_object_set(G_OBJECT(peopleNet_detection),
                 "config-file-path", "config_infer_primary_peoplenet_detection.txt",
                 NULL);
  ...
  gst_bin_add_many(GST_BIN(pipeline),
                   source, h264parser, decoder, streammux, pgie, peopleNet_detection,
...
#if 0
#ifdef PLATFORM_TEGRA
  if (!gst_element_link_many (streammux, peopleNet_detection, pgie,
